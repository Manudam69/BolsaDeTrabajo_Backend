...
const curriculumSchema = new Schema({
  //Campo de la direccion
    ...
    country: {
        type: String,
        required:[true, "Debes de especificar el país"]//Especifica que este campo es obligatorio de llenar
    },
    ...
    experience:{
        type: String,
        required:[true, "Debes de especificar tu experiencia"]}, //Especifica que este campo es obligatorio de llenar
